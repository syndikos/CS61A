...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 28 16:29:59 2017
...
def outcome_list(num_rolls, outcomes, dice=six_sided):
    """Returns a list containing all outcomes in a turn of a player"""
    if num_rolls == 0:
        return outcomes
    print(type(outcomes))
    outcomes.append(dice())
    return outcome_list(num_rolls-1, outcomes, dice=six_sided)